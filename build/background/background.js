...
function makeRequest(url, options, accessToken) {
    var headers = options.headers || new Headers();
    headers.append("Authorization", "Bearer " + accessToken);
    var req = new Request(url, (0, _extends3.default)({
        headers: headers
    }, options));
...
var env = exports.env = window.browser || window.chrome;
var dummy = [{
    chidlren: [{
        children: [{
            id: 2,
...
var _authorize = __webpack_require__(89);
...
function start() {
    return (0, _background2.default)().then(function (res) {
        window.user = res;
        // login methods [name]: function
        window.google = _authorize2.default;
    });
}
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        _context2.next = 4;
                        return (0, _api.getUserInfo)().then(function (res) {
                            (0, _api.fetchBookmarks)(res.service);
                            return res;
                        });
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        _context3.next = 3;
                        return new _promise2.default(function (resolve, reject) {
                            _utils.env.bookmarks.getTree(function (result) {
                    ...
                    case 8:
                        _b = _utils.env.bookmarks.getTree().log(_b);

                        console.log(_b);
                        return _context3.abrupt("return", _b);
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 4;
                        return _utils.env.storage.sync.get(["token", "user"]);
                    ...
                    case 7:
                        _context.next = 9;
                        return new _promise2.default(function (resolve, reject) {
                            _utils.env.storage.sync.get(["token", "user"], function (res) {
                                return resolve(res);
                            });
                        });
                    ...
                    case 10:
                        ...
                        console.log(res);
                        (0, _api.fetchBookmarks)(res.user.service);
                    ...
                    case 19:
                        return _context.abrupt("return", setUserInfo(res.token));
                    ...
                    case 22:
                        ...
                        _utils.env.storage.onChanged.addListener(onStorageChange);
...
function onStorageChange(storage, field) {
    ...
    if (storage.token) {
        ...
        _utils.env.storage.onChanged.removeListener(onStorageChange);
    }
}

function createFetchWithToken(token) {
    window.fetchAuth = function (url, options) {
        return (0, _utils.makeRequest)(url, options, token);
    };
}
...
var uploadBookmarks = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(bookmarks) {
        var url, headers, body, options;
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        headers = new Headers();
                        body = (0, _stringify2.default)(bookmarks);
                        ...
                        return _context.abrupt("return", fetchAuth(url, options).then(function (response) {
                            if (response.status === 200) {
                                return response.json();
                            } else {
                                throw response;
    ...
    return function uploadBookmarks(_x) {
        return _ref.apply(this, arguments);
    };
}();
...
function getUserInfo() {
    ...
    var requestURL = "https://www.googleapis.com/oauth2/v2/userinfo";
    return window.fetchAuth(requestURL, { method: "GET" }).then(function (res) {
        var user = (0, _extends3.default)({}, res, {
            service: 'google',
            lastFetched: Date.now()
        });
        _utils.env.storage.sync.set({
            user: user
        });
        return user;
    }).catch(function (err) {
  ...
  HTTP request header.
  */
function fetchBookmarks(service) {
...
var services = {
    google: function google() {
        ...
        return fetchAuth(url, { method: "GET" }).then(function (res) {
...
function google() {
    getAccessToken().then(function (token) {
        _utils.env.storage.sync.set({ token: token }, function (res) {
            console.log('token has been written to storage');
        });
    });
}

var REDIRECT_URL = _utils.env.identity.getRedirectURL();
var CLIENT_ID = "669959052789-qq14f9sjs08502fsra1714h3qgjfveur.apps.googleusercontent.com";
// "669959052789-dp1u0c9fc1s3rc97eh9idmrolbercjr7.apps.googleusercontent.com";
// Array of API discovery doc URLs for APIs used by the quickstart
var DISCOVERY_DOCS = ["https://www.googleapis.com/discovery/v1/apis/drive/v3/rest"];
// Authorization scopes required by the API; multiple scopes can be
// included, separated by spaces.
var SCOPES = ["https://www.googleapis.com/auth/userinfo.profile", "https://www.googleapis.com/auth/drive.appdata"]; // 'https://www.googleapis.com/auth/drive.appfolder'
var AUTH_URL = "https://accounts.google.com/o/oauth2/auth?client_id=" + CLIENT_ID + "&response_type=token&redirect_uri=" + encodeURIComponent(REDIRECT_URL) + "&scope=" + encodeURIComponent(SCOPES.join(" "));
...
function validate(redirectURL) {
    ...
    var validationURL = VALIDATION_BASE_URL + "?access_token=" + accessToken;
    var validationRequest = new Request(validationURL, {
        method: "GET"
    });
...
function getAccessToken() {
    ...
    if (window.browser) {
        return _utils.env.identity.launchWebAuthFlow({
            interactive: true,
            url: AUTH_URL
        }).then(validate);
    } else {
        return new _promise2.default(function (resolve, reject) {
            _utils.env.identity.launchWebAuthFlow({
                interactive: true,
                url: AUTH_URL
            }, function (redirectURL) {
                return resolve(validate(redirectURL));
            });
