...
var env = window.browser || window.chrome;

var btns = document.getElementById("sign-in");
var userInfo = document.getElementById("user-info");
var bg = void 0; // background page is fetching each initApp call
...
function logOut() {
    ...
    env.storage.sync.clear(function (res) {
        bg.logOut().then(function (res) {
            initApp();
        });
    });
}
...
function getBackgroundPage() {
    return window.browser ? env.runtime.getBackgroundPage() : new _promise2.default(function (resolve) {
        return env.runtime.getBackgroundPage(function (window) {
